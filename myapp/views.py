...
def calculate_energy_consumption2(request):
    ...
    for appliance in appliances:
        ...
        energy_results.append({'appliance': appliance, 'energy_consumption': energy_consumption, 'total_energy_consumption': total_energy_consumption, 'carbon_footprint': appliance_carbon_footprint})
        total_energy_sum += total_energy_consumption  # Add current appliance's energy consumption to the total sum
        payment_amount = total_energy_sum * rate_per_kwh
        
    return render(request, 'energy_consumption_result2.html', {'energy_results': energy_results, 'total_energy_sum': total_energy_sum, 'payment_amount': payment_amount, 'total_carbon_footprint': total_carbon_footprint})
num_of_epoches=13
def calculate_energy_consumption3(request):
    ...
    return render(request, 'energy_consumption_result3.html', {'energy_results': energy_results, 'total_energy_sum': total_energy_sum, 'payment_amount': payment_amount, 'total_carbon_footprint': total_carbon_footprint})
...
def calculate_energy_consumption4(request):
    ...
    return render(request, 'energy_consumption_result4.html', {'energy_results': energy_results, 'total_energy_sum': total_energy_sum, 'payment_amount': payment_amount, 'total_carbon_footprint': total_carbon_footprint})
...
def piechart(request):
    ...
    for appliance in appliances:
        ...
        energy_results.append({'appliance': appliance, 'total_energy_consumption': total_energy_consumption})  # Changed key name to 'appliance'
        total_energy_sum += total_energy_consumption
    payment_amount = total_energy_sum * Decimal('2')  # Assuming a rate of $2 per kWh
    return render(request, 'bathroom_piechart.html', {'energy_results': energy_results, 'payment_amount': payment_amount})  # Corrected context variable name
def piechart1(request):
    ...
    for appliance in appliances:
        ...
        energy_results.append({'appliance': appliance, 'total_energy_consumption': total_energy_consumption})  # Changed key name to 'appliance'
        total_energy_sum += total_energy_consumption
    payment_amount = total_energy_sum * Decimal('2')  
    return render(request, 'bedroom_piechart.html', {'energy_results': energy_results, 'payment_amount': payment_amount})  # Corrected context variable name\
...
def piechart2(request):
    ...
    for appliance in appliances:
        ...
        total_energy_sum += total_energy_consumption
    payment_amount = total_energy_sum * Decimal('2')  # Assuming a rate of $2 per kWh
    return render(request, 'kitchen_piechart.html', {'energy_results': energy_results, 'payment_amount': payment_amount})  # Corrected context variable name
...
def piechart3(request):
    ...
    for appliance in appliances:
        ...
        total_energy_sum += total_energy_consumption
    payment_amount = total_energy_sum * Decimal('2')  # Assuming a rate of $2 per kWh
    return render(request, 'dininghall_piechart.html', {'energy_results': energy_results, 'payment_amount': payment_amount})  # Corrected context variable name
...
def piechart4(request):
    ...
    for appliance in appliances:
        ...
        total_energy_sum += total_energy_consumption
    payment_amount = total_energy_sum * Decimal('2')  # Assuming a rate of $2 per kWh
    return render(request, 'livingroom_piechart.html', {'energy_results': energy_results, 'payment_amount': payment_amount})  # Corrected context variable name
...
def scatterplot(request):
    ...
    return render(request, 'scatterplot.html', {'energy_results': energy_results, 'payment_amount': payment_amount})  # Corrected context variable name
def scatterplot1(request):
    ...
    return render(request, 'scatterplot1.html', {'energy_results': energy_results, 'payment_amount': payment_amount})  # Corrected context variable name
def scatterplot2(request):
    ...
    return render(request, 'scatterplot2.html', {'energy_results': energy_results, 'payment_amount': payment_amount})  # Corrected context variable name
def scatterplot3(request):
    ...
    return render(request, 'scatterplot3.html', {'energy_results': energy_results, 'payment_amount': payment_amount})  # Corrected context variable name
...
def scatterplot4(request):
    ...
    return render(request, 'scatterplot4.html', {'energy_results': energy_results, 'payment_amount': payment_amount})  # Corrected context variable name
...
def k_nearest_neighbours(request):
    ...
    knn_random = RandomizedSearchCV(estimator=knn_model, param_distributions=param_grid, n_iter=100, cv=3, verbose=2, random_state=42, n_jobs=-1)
...
def linear_regression(request):
    ...
    lr_random = RandomizedSearchCV(estimator=lr_model, param_distributions=param_grid, n_iter=100, cv=3, verbose=2, random_state=42, n_jobs=-1)
...
def svm(request):
    ...
    svm_model = SVR()
    svm_random = RandomizedSearchCV(estimator=svm_model, param_distributions=param_grid, n_iter=100, cv=3, verbose=2, random_state=42, n_jobs=-1)
